...
# CALL_OUTPUT=$(sui client call --function $FUNCTION_NAME --module $MODULE_NAME --package $PACKAGE_ID --type-args $COINTYPEA --args  --gas-budget $GAS_BUDGET_CALL)
# echo "Call Output: $CALL_OUTPUT" >> $OUTPUT_FILE
